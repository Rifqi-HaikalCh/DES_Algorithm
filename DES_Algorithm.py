...
Tekinter = Tk()
Tekinter.geometry("600x700")
Tekinter.title("Kelompok 2")
Tekinter.configure(background="gray")
...
judul_label = Label(
    Tekinter, text="ALGORITMA DES", font=("Helvetica", 24, "bold"), bg="gray"
)
judul_label.place(relx=0.5, rely=0.1, anchor="center")


Label1 = Label(Tekinter, text="Key", font="Helvetica 12 bold", bg="gray")
Label1.place(x=140, y=100)

ED_Key = Entry(Tekinter, textvariable=mainKey, font="Helvetica 12 bold", width="50")
ED_Key.place(x=50, y=145)

Label2 = Label(Tekinter, text="The Plain Text", font="Helvetica 12 bold", bg="gray")
Label2.place(x=140, y=200)

clearBtn1 = Button(
    Tekinter, text="Clear", width="8", font="Helvetica 12 bold", command=clear1
)
clearBtn1.place(x=435, y=290)

# Menempatkan plaintext dan clear button di bawahnya
plainText = ScrolledText(Tekinter, height=5, width=40)
plainText.place(x=60, y=240)

Label3 = Label(Tekinter, text="The Cipher Text", font="Helvetica 12 bold", bg="gray")
Label3.place(x=140, y=400)

clearBtn2 = Button(
    Tekinter, text="Clear", width="8", font="Helvetica 12 bold", command=clear2
)
clearBtn2.place(x=435, y=485)

# Menempatkan ciphertext di bawah plaintext
cipherText = ScrolledText(Tekinter, height=5, width=40)
cipherText.place(x=60, y=440)

encBtn = Button(
    Tekinter, text="Encrypt", width="8", font="Helvetica 12 bold", command=Encrypt
)
encBtn.place(x=435, y=245)

decBtn = Button(
    Tekinter, text="Decrypt", width="8", font="Helvetica 12 bold", command=Decrypt
)
decBtn.place(x=435, y=440)
